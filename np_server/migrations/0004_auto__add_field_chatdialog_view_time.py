...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChatDialog.view_time'
        db.add_column(u'np_server_chatdialog', 'view_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChatDialog.view_time'
        db.delete_column(u'np_server_chatdialog', 'view_time')
    ...
    models = {
        ...
        u'np_server.chatdialog': {
            ...
            'view_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'np_server.updatedevice': {
            ...
            'date1': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 26, 0, 0)', 'blank': 'True'}),
            'date2': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 26, 0, 0)', 'blank': 'True'}),
            'date3': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 26, 0, 0)', 'blank': 'True'}),
