...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChatDialog'
        db.create_table(u'np_server_chatdialog', (
        ...
        db.send_create_signal(u'np_server', ['ChatDialog'])

        # Adding model 'ChatMessage'
        db.create_table(u'np_server_chatmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dialog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['np_server.ChatDialog'])),
        ...
        db.send_create_signal(u'np_server', ['ChatMessage'])


    def backwards(self, orm):
        # Deleting model 'ChatDialog'
        db.delete_table(u'np_server_chatdialog')

        # Deleting model 'ChatMessage'
        db.delete_table(u'np_server_chatmessage')
    ...
    models = {
        ...
        u'np_server.chatmessage': {
            ...
            'dialog': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['np_server.ChatDialog']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
